...
public class Lab1_Graph {
  ...
  static class DirectedGraph {
    ...
    @SuppressFBWarnings({"PSC_PRESIZE_COLLECTIONS", "PSC_PRESIZE_COLLECTIONS", "MUI_CONTAINSKEY_BEFORE_GET"})
    ...
    // 计算最短路径（Dijkstra）
    @SuppressFBWarnings({"PSC_PRESIZE_COLLECTIONS", "PSC_PRESIZE_COLLECTIONS", "PSC_PRESIZE_COLLECTIONS"})
    ...
    @edu.umd.cs.findbugs.annotations.SuppressFBWarnings("UCPM_USE_CHARACTER_PARAMETERIZED_METHOD")
  ...
  public static Double calPageRank(DirectedGraph graph, String word) {
    ...
    Map<String, Double> pr = graph.computePageRank();
    return pr.get(word);
  }

  /** 随机游走 */
  @SuppressFBWarnings({"PREDICTABLE_RANDOM", "LSC_LITERAL_STRING_COMPARISON", "DM_DEFAULT_ENCODING", "DMI_RANDOM_USED_ONLY_ONCE"})
  ...
  /** 主函数 */
  @SuppressFBWarnings({"VA_FORMAT_STRING_USES_NEWLINE", "DM_DEFAULT_ENCODING"})
